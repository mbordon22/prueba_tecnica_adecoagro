...
<div class="container">
    <div class="row d-md-flex justify-content-center ">
        <div class="col-12 col-md-8 compras form content">
            ...
            <fieldset>
                <legend class="mb-3"><?= __('Nueva Compra') ?></legend>
                <div class="row">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-12 col-md-4 mb-3 mb-md-0">
                        <?= $this->Form->control('fecha', ['type' => 'datetime','label' =>'Fecha y Hora','value' => (date('Y-m-d H:m:s')), 'class' => 'form-control']);?>
                    </div>
                    <div class="col-12 col-md-3">
                        <?= $this->Form->control('importe', ['type' => 'text', 'readonly' => true, 'id' => 'importe_total', 'label' => 'Importe Total', 'class' => 'form-control']); ?>
                    </div>
                </div>
